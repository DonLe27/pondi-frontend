...
class StreamHolder extends React.Component {
      ...
      prompts: [
        {
          ...
          content:
            "this is some content. This is some more content. This is more content",
          date: "Jan 1, 1111",
          avatar: "/hedgehog-clipart-black-and-white-1.png"
        },
        {
          ...
          content:
            "this is some more content. Lorem ipsum something dolor blah",
          date: "Jan 1, 1111",
          avatar: "/hedgehog-clipart-black-and-white-1.png"
        }
      ]
      ...
      prompts: [
        {
          ...
          content:
            "this is some content. This is some more contnet. This is more content",
          date: "Jan 1, 1111",
          avatar: "/hedgehog-clipart-black-and-white-1.png"
        },
        {
  ...
  addStream(i) {
    if (!this.state.stream) {
      ...
      const right = (
        <Stream key={0} streamData={this.streamData} userData={this.userData} />
      );
      setTimeout(
        function() {
  ...
  addOcean(i) {
    if (!this.state.ocean) {
      ...
      const right = (
        <Ocean key={1} streamData={this.streamData} userData={this.userData} />
      );
      setTimeout(
        function() {
          this.setState({ rightSide: right });
